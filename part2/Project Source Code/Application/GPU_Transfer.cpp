...
void GPU_Transfer::send() 
{
	...
	{
		// Generate a new buffer object at objectIDs[VERTEX_ID]
		glGenBuffers(1, &objectIDs[VERTEX_ID]);
	...
	{
		// Generate a new buffer object at objectIDs[VERTEX_ID]
		glGenBuffers(1, &objectIDs[NORMAL_ID]);
		// then bind it for use
	...
	{
		// Generate a new buffer object at objectIDs[TEXTURE_ID]
		glGenBuffers(1, &objectIDs[TEXTURE_ID]);
		// then bind it for use
	...
	{
		// Generate a new buffer object at objectIDs[COLOUR_ID]
		glGenBuffers(1, &objectIDs[COLOUR_ID]);
		// then bind it for use
	...
	if (indices != NULL)
	{
		// Generate a new buffer object at objectIDs[INDICE_ID]
		glGenBuffers(1, &objectIDs[INDICE_ID]);
		// then bind it for use
